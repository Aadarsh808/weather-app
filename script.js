...
function getWeatherData(city,unit,hourlyorweek){
    const apiKey="RNDKHEKNUU2WKRWLLFRPXT783"
    fetch(`https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${city}?unitGroup=metric&key=RNDKHEKNUU2WKRWLLFRPXT783&contentType=json`,
    {
        method:"GET",
        headers:{},
    })
...
function updateAirQualityStatus(airQuality){
    if(airQuality<=50){
        ...
        airQualityStatus.innerText="Hazadous";
    }
}
...
function getIcon(condition){
    if(condition === "Partly-cloudy-day"){
        return "icon/weathericon.webp";
    }else if(condition === "Partly-cloudy-night" ){
        return "images/moon.jpg";
    }else if(condition === "rain" ){
        return "images/rains.webp";
...
function changeUnit(unit){
    if(currentUnit !== unit ){
        ...
        // call weather after change unit
